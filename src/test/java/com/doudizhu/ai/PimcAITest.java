...
class PimcAITest {
    ...
    void testPassInferenceIsPriorityNotHardReject() {
        ...
        state.applyMove(com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.FIVE.getValue(), List.of(Rank.FIVE), 0));
        state.applyMove(com.doudizhu.model.Move.pass(1));
        PublicView view = state.getPublicView(0);
    ...
    void testHonestWinRateEstimation() {
        ...
        // 玩家 1 出 5
        state.applyMove(com.doudizhu.model.Move.of(com.doudizhu.model.CardType.SINGLE, Rank.FIVE.getValue(), List.of(Rank.FIVE), 1));
        // 玩家 2 出 A
        state.applyMove(com.doudizhu.model.Move.of(com.doudizhu.model.CardType.SINGLE, Rank.ACE.getValue(), List.of(Rank.ACE), 2));
        // 此时轮到玩家 0 (我方)，只能 PASS
        PublicView view = state.getPublicView(0);
    ...
    void testHardGuardBlocksControlOvershoot() {
        ...
        Move last = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.NINE.getValue(), List.of(Rank.NINE), 1);
        Move two = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.TWO.getValue(), List.of(Rank.TWO), 0);
        Move ten = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.TEN.getValue(), List.of(Rank.TEN), 0);
        ...
        Move chosen = PimcAiPlayer.selectWithHardGuards(
                ...
                java.util.List.of(two, ten, com.doudizhu.model.Move.pass(0)),
    ...
    void testHardGuardBlocksLeadBreakSet() {
        ...
        Move break3 = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.THREE.getValue(), List.of(Rank.THREE), 0);
        Move lead4 = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.FOUR.getValue(), List.of(Rank.FOUR), 0);
    ...
    void testHardGuardBlocksPairOvershoot() {
        ...
        Move last = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.PAIR, Rank.THREE.getValue(),
                java.util.List.of(Rank.THREE, Rank.THREE), 1);
        Move tens = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.PAIR, Rank.TEN.getValue(),
                java.util.List.of(Rank.TEN, Rank.TEN), 0);
        Move fives = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.PAIR, Rank.FIVE.getValue(),
        ...
        Move chosen = PimcAiPlayer.selectWithHardGuards(
                ...
                java.util.List.of(tens, fives, com.doudizhu.model.Move.pass(0)),
                hand, last, false, false);
    ...
    void testHardGuardPassInsteadOfBreakPair() {
        ...
        Move last = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.SEVEN.getValue(), List.of(Rank.SEVEN), 1);
        Move king = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.KING.getValue(), List.of(Rank.KING), 0);
        Move pass = com.doudizhu.model.Move.pass(0);
    ...
    void testFarmerNeverBeatsTeammate() {
        ...
        state.applyMove(com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.THREE.getValue(), List.of(Rank.THREE), 0));
        state.applyMove(com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.KING.getValue(), List.of(Rank.KING), 1));
    ...
    void testHardGuardBlocksLeadBreakWhenSinglesExist() {
        ...
        Move break8 = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.EIGHT.getValue(), List.of(Rank.EIGHT), 0);
        Move lead3 = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.THREE.getValue(), List.of(Rank.THREE), 0);
        Move pair10 = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.PAIR, Rank.TEN.getValue(),
                java.util.List.of(Rank.TEN, Rank.TEN), 0);
    ...
    void testHardGuardEndgamePreferAceOverRocket() {
        ...
        Move last = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.FOUR.getValue(), List.of(Rank.FOUR), 1);
        Move rj = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.RED_JOKER.getValue(), List.of(Rank.RED_JOKER), 0);
        Move ace = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.ACE.getValue(), List.of(Rank.ACE), 0);
        ...
        Move chosen = PimcAiPlayer.selectWithHardGuards(
                ...
                java.util.List.of(rj, ace, com.doudizhu.model.Move.pass(0)),
                hand, last, false, false);
    ...
    void testHardGuardRejectsBurningControlAsAccessory() {
        ...
        Move last = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.TRIPLE_PLUS_PAIR, Rank.NINE.getValue(),
                java.util.List.of(Rank.NINE, Rank.NINE, Rank.NINE, Rank.FIVE, Rank.FIVE), 0);
        Move burn = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.TRIPLE_PLUS_PAIR, Rank.TWO.getValue(),
                java.util.List.of(Rank.TWO, Rank.TWO, Rank.TWO, Rank.TEN, Rank.TEN), 1);
        Move pass = com.doudizhu.model.Move.pass(1);
    ...
    void testRescueBeaterWhenDeadWithControl() {
        ...
        Move last = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.JACK.getValue(), List.of(Rank.JACK), 0);
        Move two = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.TWO.getValue(), List.of(Rank.TWO), 1);
        Move rj = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.RED_JOKER.getValue(), List.of(Rank.RED_JOKER), 1);
        Move ace = com.doudizhu.model.Move.of(
                com.doudizhu.model.CardType.SINGLE, Rank.ACE.getValue(), List.of(Rank.ACE), 1);
        Move pass = com.doudizhu.model.Move.pass(1);
